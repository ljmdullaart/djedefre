function buildNwOverview() {
    const table = document.getElementById("nwOverview");
    table.innerHTML = "";
...
function toggleNwStatus(server) {
...
document.addEventListener("DOMContentLoaded", () => {
    ...
    buildNwOverview();
    setInterval(buildNwOverview, 300000); // 5 minutes
});
