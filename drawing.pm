...
sub add_l3_lines {
    ...
    # We work on a copy, like your original @dr_cpy
    my @dr_cpy = @$drawing;
        ...
        if ($object->{tbl} eq 'server') {
            ...
            for my $row (@$ifref) {
                ...
                for my $net (@$subnets) {
                    ...
                    # IMPORTANT: only connect if IP really is in subnet
                    # (this is what prevents "Internet → every server")
